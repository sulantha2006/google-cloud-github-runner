...
| <a name="input_github_runners_reconcile_give_up_hours"></a> [github\_runners\_reconcile\_give\_up\_hours](#input\_github\_runners\_reconcile\_give\_up\_hours) | Hours after which the reconciler stops creating VMs for a still-queued job | `number` | `6` | no |
