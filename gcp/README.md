...
| <a name="input_github_runners_reconcile_exclude_repositories"></a> [github\_runners\_reconcile\_exclude\_repositories](#input\_github\_runners\_reconcile\_exclude\_repositories) | Repositories (owner/repo) the reconciler ignores; every other repository of the GitHub App installation is scanned | `list(string)` | `[]` | no |
