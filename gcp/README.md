...
| <a name="input_github_runners_reconcile_repositories"></a> [github\_runners\_reconcile\_repositories](#input\_github\_runners\_reconcile\_repositories) | Repositories (owner/repo) the reconciler scans; empty means every repository of the GitHub App installation | `list(string)` | `[]` | no |
